...
public class TransactionsResource {
    ...
    @ResponseBody
    public ResponseEntity<List<TransactionOutputDTO>> hello(@PathVariable("id") String id, @PathVariable("ano") String year, @PathVariable("mes") String month) throws BusinessRuleException {
